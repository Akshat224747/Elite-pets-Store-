...
const SHEET_URL = 'https://docs.google.com/forms/d/e/1FAIpQLSeQPAxefepF_KW1-HBq3pfHtEW_OFheTaz6KnKKYe5Pc3rZwg/formResponse'
...
export default function ProductDetail({ product }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      body.append('entry.1831552674', form.name)
      body.append('entry.1594924566', form.email)
      body.append('entry.1065046570', form.phone)
      body.append('entry.1166974658', form.address)
      body.append('entry.1411731572', form.city)
      body.append('entry.745745027', form.state)
      body.append('entry.1362910749', form.zip)
      body.append('entry.2050436189', `${product.name} - ${selectedSize}`)
