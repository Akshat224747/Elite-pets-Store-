        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
            ...
            <div className="flex flex-col">
              ...
              <button onClick={() => { setShowForm(true); setShowPayPal(false) }}
        ...
        <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center"
          ...
          <div className="w-full md:max-w-2xl rounded-t-3xl md:rounded-2xl overflow-hidden"
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-white/10">
              <div>
                <h3 className="text-white font-bold text-lg">Step 1: Enter Your Details</h3>
            ...
            <div style={{overflowY:'auto', maxHeight:'60vh'}}>
              <iframe
                src={formUrl}
                className="w-full"
                style={{height:'55vh', border:'none', background:'#ffffff'}}
                title="Order Form"
              />
            </div>
            {/* PayPal button at bottom of form */}
            <div className="px-5 py-4 border-t border-white/10">
              <p className="text-gray-400 text-xs text-center mb-3">✅ After filling the form above, click to pay</p>
              <button onClick={handlePayPal}
                className="w-full py-3 rounded-full font-bold text-white text-base transition-all active:scale-95 flex items-center justify-center gap-2"
