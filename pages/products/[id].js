          ...
          <div className="w-full md:max-w-2xl rounded-t-3xl md:rounded-2xl overflow-hidden"
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-white/10">
              <div>
                ...
                <p style={{color:'#f59e0b'}} className="text-xs font-semibold">{product.name} · {selectedSize} · ${product.price}</p>
              </div>
            ...
            <iframe
              src="https://docs.google.com/forms/d/e/1FAIpQLSeQPAxefepF_KW1-HBq3pfHtEW_OFheTaz6KnKKYe5Pc3rZwg/viewform?embedded=true"
              className="w-full"
